				...
				<div class="row">
					<div class="span12">
						<div class="header">
							...
							<div class="row1">
								<div class="span3">
                                <a href="#" id="logo"><img class="logo_c fade-in one"" src="media/LOGO/logo.png"></a>
								</div>
				...
				<div class="row">
					<div class="main-category-slider">
						<div>
							...
							<div class="span2 product-small">
								<div class="product-overflow-keeper">
									<img class="product-image" src="media/product-small-2.png" />
									<div class="product-info">
										<span class="product-price">&nbsp;</span>
										<a href="#" class="product-name">&nbsp;</a>
									</div>
							...
							<div class="span2 product-small">
								<div class="product-overflow-keeper">
									<img class="product-image" src="media/product-small-3.png" />
									<div class="product-info">
										<span class="product-price">&nbsp;</span>
										<a href="#" class="product-name">&nbsp;</a>
									</div>
							...
							<div class="span2 product-small">
								<div class="product-overflow-keeper">
									<img class="product-image" src="media/product-small-4.png" />
									<div class="product-info">
										<span class="product-price">&nbsp;</span>
										<a href="#" class="product-name">&nbsp;</a>
									</div>
		...
		<div class="container">
			<div class="row">
				<div class="span3 side-options phone-span-diff">
					<h3 class="subheading">Beauty Products</h3>
					<div class="prod">Olay</div>
                    <div class="prod">Lakme</div>
                    <div class="prod">Dove</div>
                    <div class="prod">Garnier</div>
                    <div class="prod">Ponds</div>
                    <div class="prod">L'oreal</div>
                    <br>
					<h3 class="subheading hidden-phone">Products of The Week</h3>
					<div class="row">
						<div class="span2 product-small">
							<div class="product-overflow-keeper">
								<img class="product-image" src="media/product-small-1.png" />
				...
				<div class="span9">
					<div class="row">
						<div class="span9">
							<h2 class="section-heading">Hall of Fame</h2>
						</div>
					</div>

					<div class="row hall-fame">
						...
						<div class="diagonal-holder out-of-bound visible-desktop">
							<div class="slider-diagonal-overflow">
					...
					<div class="row">
						<div class="span9 filter-controls phone-span-diff">
							...
							<a href="#" class="filter">Product compare (0)</a>
							<div class="control-dropdown">
