		...
		<div class="container">
			<div class="row">
				<div class="span3 side-options phone-span-diff">
                    ...
                    <div class="prod">Hairs</div>
					<div class="prod">Eyes</div>
                    <div class="prod">Nose</div>
                    <div class="prod">Lips</div>
                    <div class="prod">Face</div>
                    <div class="prod">Neck</div>
                    <div class="prod">Breast</div>
                    <div class="prod">Nails</div>
                    <div class="prod">Skin</div>
